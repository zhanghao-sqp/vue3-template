...
// v-input:type="inputValue"
export const input: ObjectDirective = {
	mounted(el, { arg, value }) {
		// 判断arg是否是InputType类型
		const types: InputType[] = ['number', 'decimal', 'decimal_2', 'customize']
		if (!arg || !types.includes(arg as InputType)) {
			return console.log(
